  ...
  public static function parseVariable($variable) {
    if(is_numeric($variable))
    {
      if(self::isFloat($variable))
        return (float)self::toFloat($variable);
      else if (self::isInt($variable))
        return (int)self::toInt($variable);
    } 
    else if (self::isBool($variable))
      return (bool)self::toBool($variable);
